...
class Storage {
    ...
    static displayItems() {
        readFile(items => {
            ...
            items.forEach(item => {
                document.querySelector('#need').innerHTML += `<ons-list-item  style='margin-top: 1.5px;background-color: ${item.isEssential ? 'lightgreen' : 'lightblue'}; class='btn' id='item${i++}'> <div class='left' width='20%'> <ons-icon icon="fa-cart-arrow-down" class="list-item__icon"></ons-icon>
